...
export class GamificationService {
  ...
  private async gatherStats(userId: string) {
    const [
      ...
      this.prisma.channel.count({
        where: { userId, isActive: true, type: { in: ['WHATSAPP', 'TELEGRAM'] } },
      }),
  ...
  private buildAchievements(
    stats: Awaited<ReturnType<GamificationService['gatherStats']>>,
  ): Achievement[] {
    return [
      ...
      { key: 'lists_3', title: 'Create 3 lists', completed: stats.listCount >= 3 },
      {
        ...
        completed: stats.reminderCount >= 1,
      },
      ...
      { key: 'first_task', title: 'Create your first task', completed: stats.taskCount >= 1 },
      {
        ...
        completed: stats.completedTaskCount >= 1,
      },
      { key: 'tasks_done_5', title: 'Complete 5 tasks', completed: stats.completedTaskCount >= 5 },
      {
        key: 'task_with_due_date',
        title: 'Create a task with a due date',
        completed: stats.taskWithDueDateCount >= 1,
      },
      {
      ...
      {
        key: 'first_share',
        title: 'Share a list or reminder with someone',
        completed: stats.shareCount >= 1,
      },
      {
      ...
      {
        key: 'cleanup_5',
        title: 'Review 5 memories in Clean up',
        completed: stats.keptMemoryCount >= 5,
      },
      {
        key: 'cleanup_10',
        title: 'Review 10 memories in Clean up',
        completed: stats.keptMemoryCount >= 10,
      },
      {
        key: 'first_friend',
        title: 'Add your first friend',
        completed: stats.acceptedFriendCount >= 1,
      },
